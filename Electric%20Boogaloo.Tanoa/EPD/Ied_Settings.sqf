...
smallChance = 33; //Chance that a small IED will be chosen.
mediumChance = 33; //Chance that a medium IED will be chosen.
largeChance = 34; //Chance that a large IED will be chosen.
...
iedLargeItems = ["Land_CanisterOil_F","Land_FMradio_F","Land_Canteen_F","Land_CerealsBox_F","Land_BottlePlastic_V1_F","Land_HandyCam_F","Land_PowderedMilk_F","Land_RiceBox_F","Land_TacticalBacon_F","Land_VitaminBottle_F","Land_BottlePlastic_V2_F","Land_Bricks_V2_F","Land_Bricks_V3_F","Land_Bricks_V4_F","Land_GarbageBags_F","Land_GarbagePallet_F","Land_GarbageWashingMachine_F","Land_JunkPile_F","Land_Tyres_F","Land_Wreck_Skodovka_F","Land_Wreck_Car_F","Land_Wreck_Car3_F","Land_Wreck_Car2_F","Land_Wreck_Offroad_F","Land_Wreck_Offroad2_F"];
...
iedInitialArray = [
	//["AllCities",["West","east","civ","guer"]],
	//["AllVillages",["West","east","civ","guer"]],
	/*["AltisRandom1",6,"West"],
	["AltisRandom2",6,"West"],
	["AltisRandom3",6,"West"],
	["AltisRandom4",6,"West"],
	...
	//["OreoKastro", "West"],
	//["Athira", 2, "West" ],
	["IED1", 100, [5, 5, 0, 90],["West","east","civ","guer"]],
