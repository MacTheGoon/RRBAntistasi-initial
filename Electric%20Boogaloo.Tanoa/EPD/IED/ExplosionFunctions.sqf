EXPLOSIVESEQUENCE_SMALL = {
	_explosiveSequence = ["SatchelCharge_Remote_Ammo","M_Titan_AP"]; 
...
EXPLOSIVESEQUENCE_LARGE = {
	_explosiveSequence = ["Bo_GBU12_LGB_MI10", "ammo_Missile_Cruise_01"];
...
EXPLOSIVESEQUENCE_SECONDARY = {
	_explosiveSequence = ["R_80mm_HE","ClaymoreDirectionalMine_Remote_Ammo"];
