...
if (hasFFAA) then
	...
	if (gameMode != 4) then
		...
		groupsFIASmall = [["CFP_B_UGARMY_Squad_Leader_01","CFP_B_UGARMY_Rifleman_01","CFP_B_UGARMY_Machine_Gunner_01","CFP_B_UGARMY_Rifleman_AT_01"]];//["IRG_InfSentry","IRG_ReconSentry","IRG_SniperTeam_M"];///
		groupsFIAMid = [["CFP_B_UGARMY_Squad_Leader_Light_01","CFP_B_UGARMY_Rifleman_AT_Light_01","CFP_B_UGARMY_Medic_Light_01","CFP_B_UGARMY_Explosive_Specialist_Light_01","CFP_B_UGARMY_Machine_Gunner_Light_01","CFP_B_UGARMY_Grenadier_Light_01","CFP_B_UGARMY_Engineer_Light_01","CFP_B_UGARMY_Rifleman_Light_01"]];//["IRG_InfAssault","IRG_InfTeam","IRG_InfTeam_AT"];///
		FIASquad = ["CFP_B_UGARMY_Squad_Leader_01","CFP_B_UGARMY_Medic_01","CFP_B_UGARMY_Explosive_Specialist_01","CFP_B_UGARMY_Grenadier_01","CFP_B_UGARMY_Machine_Gunner_01","CFP_B_UGARMY_Rifleman_AT_01","CFP_B_UGARMY_Engineer_01","CFP_B_UGARMY_Rifleman_01"];//"IRG_InfSquad";///
		groupsFIASquad = [FIASquad];
		factionFIA = "CFP_B_CAF";
		}
	else
		{
...
vehPoliceCar = "CFP_B_KEARMY_Landrover_M2_01";
policeOfficer = "CFP_B_KEARMY_Squad_Leader_GSU_Recce_01";
policeGrunt = "CFP_B_KEARMY_Squad_Leader_20th_PB_01";
groupsNATOGen = [policeOfficer,policeGrunt];
nameTeamPlayer = "Boogaloo";

factionGEN = "CFP_B_KEARMY";
