...
smallChance = 5; //Chance that a small IED will be chosen.
mediumChance = 5; //Chance that a medium IED will be chosen.
largeChance = 90; //Chance that a large IED will be chosen.
